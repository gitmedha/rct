...
const LandingPage = ()=> {
  ...
  return (
    ...
    <>
            <Grid container style={{ display: 'flex' ,backgroundColor:'#31B89D', marginTop:0, marginBottom:0,paddingBottom:'5rem'}}>
                <Container>
                        <Grid container style={{ display: 'flex'}} marginTop={5} marginBottom={5}>
                            <Grid item style={{ flex: 1 }} xs={12} sm={12} md={6} lg={6} xl={6} >
                                    ...
                                    <Box sx={{marginTop:'10px'}}>
                                        <div className="header_body_sec">Principal Investigator <a href='https://faculty.wcas.northwestern.edu/lab823/'>Lori Beaman</a>
and her team have undertaken the development, testing, and implementation of three distinct assessments to evaluate the employability impact of Medha's Career Advancement Bootcamp (CAB) through randomized controlled trials (RCTs).
        ...
        <Container>
           ...
           <Box display={'flex'} marginTop={4} marginBottom={4}>
                <div style={{height:'34px', width:'15px', backgroundColor:'orange'}}>     
                </div>
